...
def move_handle(build_ele, handle_prop, input_pnt, doc):
    ...
    if (handle_prop.handle_id == "BalkaHeight"):
        build_ele.RibHeight.value = build_ele.BalkaHeight.value - build_ele.TopShHeight.value - build_ele.BotShLowHeight.value - build_ele.BotShUpHeight.value
        if (build_ele.HoleHeight.value > build_ele.BalkaHeight.value - build_ele.TopShHeight.value - 45.5):
            build_ele.HoleHeight.value = build_ele.BalkaHeight.value - build_ele.TopShHeight.value - 45.5
...
def modify_element_property(build_ele, name, value):
    ...
    if (name == "BalkaHeight"):
        ...
        build_ele.BalkaHeight.value = value + build_ele.RibHeight.value + build_ele.BotShUpHeight.value + build_ele.BotShLowHeight.value
    elif (name == "RibHeight"):
        build_ele.BalkaHeight.value = value + build_ele.TopShHeight.value + build_ele.BotShUpHeight.value + build_ele.BotShLowHeight.value
    elif (name == "BotShUpHeight"):
        build_ele.BalkaHeight.value = value + build_ele.TopShHeight.value + build_ele.RibHeight.value + build_ele.BotShLowHeight.value
        ...
        build_ele.BalkaHeight.value = value + build_ele.TopShHeight.value + build_ele.RibHeight.value + build_ele.BotShUpHeight.value
        ...
        if (value > build_ele.BalkaHeight.value - build_ele.TopShHeight.value - 45.5):
            build_ele.HoleHeight.value = build_ele.BalkaHeight.value - build_ele.TopShHeight.value - 45.5
...
class CreateBridgeBeam():
    ...
    def create(self, build_ele):
        ...
        self._beam_height = build_ele.BalkaHeight.value
    ...
    def create_handles(self, build_ele):
        ...
        handle2 = HandleProperties("BalkaHeight",
                                   AllplanGeo.Point3D(0., 0., self._beam_height),
                                   AllplanGeo.Point3D(0, 0, 0),
                                   [("BalkaHeight", HandleDirection.point_dir)],
                                   HandleDirection.point_dir, True)
